...
export default {
  ...
  data() {
    return {
      stats: [
        { title: 'TOTAL VISITS', value: '1032', id: 'TotalEarn' },
        { title: 'TOTAL USERS', value: '5036', id: 'Purchases' },
        { title: 'PENDING VISITS', value: '5', id: 'Customers' },
        { title: 'APPROVE VISITS', value: '1032', id: 'PendingOrders' },
      ],
      userName: '',
      userEmail: '',
    };
